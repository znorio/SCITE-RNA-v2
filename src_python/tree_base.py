...
class PruneTree:
    """
    [Basic idea]
        - A tree structure that allows pruning subtrees and re-inserting them
    ...
    def use_parent_vec(self, new_parent_vec, main_root=None):
        """
        Replace the parent vector with a new one.
        """
        ...
        self._clist = [[] for _ in range(self.n_vtx)] + [[]]
    ...
    # Methods to manipulate the tree structure
