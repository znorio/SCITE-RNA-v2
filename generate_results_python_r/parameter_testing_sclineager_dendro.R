...
generate.parent.vec <- function(base_path, n.tests=10, run_sclineager=TRUE, run_dendro=TRUE) {
...
for (i in seq_along(paths)) {
  path <- paths[i]
  generate.parent.vec(path, n_tests, run_sclineager = TRUE, run_dendro = FALSE)
}
